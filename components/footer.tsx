...
export function Footer() {
  return (
    <footer className="relative overflow-hidden" style={{ background: "#080809", borderTop: "1px solid rgba(255,255,255,0.07)" }}>
      <div className="h-[2px]" style={{ background: "linear-gradient(90deg, var(--primary), rgba(194,164,109,0.4), transparent)" }} />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <div className="mb-4">
              ...
              <p className="text-[8px] tracking-[0.35em] uppercase mt-1" style={{ color: "rgba(255,255,255,0.22)" }}>Precision Over Noise</p>
                <p className="text-[8px] tracking-[0.35em] uppercase mt-1" style={{ color: "#C2A46D" }}>Structured Brand System</p>
            </div>
            ...
            <div className="flex gap-3 mt-6">
              {socials.map(({ Icon, href, label }) => (
                <a
                  ...
                  onMouseEnter={(e) => { const el = e.currentTarget as HTMLElement; el.style.background = "var(--primary)"; el.style.borderColor = "var(--primary)"; el.style.color = "white" }}
          ...
          <div>
            ...
            <div className="space-y-3.5">
              {[
                  { Icon: Mail, text: "hello@loechsar.com" },
                { Icon: MapPin, text: "Lagos / Global" },
              ].map(({ Icon, text }) => (
                <div key={text} className="flex items-center gap-3">
                  <Icon className="h-3.5 w-3.5 flex-shrink-0" style={{ color: "var(--primary)" }} />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            <p className="text-[9px] uppercase tracking-widest" style={{ color: "rgba(255,255,255,0.18)" }}>© LO ECHSAR 2026 — All rights reserved</p>
