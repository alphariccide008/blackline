...
const values = [
  ...
  { num: "04", title: "Longevity",   desc: "We build brands that endure. Not campaigns that expire. The LO ECHSAR system is built to compound over time." },
]
  ...
  return (
    <main style={{ background: "#0A0A0C" }} className="min-h-screen">
      ...
      <section className="relative pt-40 pb-24 overflow-hidden" style={{ background: "#0A0A0C" }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 70% 60% at 50% 0%, rgba(194,164,109,0.14), transparent)" }} />
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-8 h-px" style={{ background: "#C2A46D" }} />
            <span className="text-[9px] font-black uppercase tracking-[0.38em]" style={{ color: "#C2A46D" }}>About LO ECHSAR</span>
          </div>
          <h1 className="text-[clamp(3rem,8vw,7rem)] font-black tracking-tight leading-none mb-8" style={{ color: "#EDEDED" }}>
            We Build<br />Brands That<br /><span style={{ color: "#C2A46D" }}>Move Markets.</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="flex items-center gap-3 mb-8">
                <div className="w-8 h-px" style={{ background: "#C2A46D" }} />
                <span className="text-[9px] font-black uppercase tracking-[0.38em]" style={{ color: "#C2A46D" }}>Our Mission</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black leading-tight mb-6" style={{ color: "#F3F1EC" }}>Structured Brand System.</h2>
              <p className="text-sm leading-relaxed mb-4" style={{ color: "rgba(243,241,236,0.7)" }}>
                The market is saturated with brands that say everything and mean nothing. LO ECHSAR exists to change that  for the brands we work with, and for the standard of brand work on the continent.
              </p>
              <p className="text-sm leading-relaxed" style={{ color: "rgba(243,241,236,0.7)" }}>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden" style={{ height: 420 }}>
                <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=800&q=80" alt="LO ECHSAR team at work" className="w-full h-full object-cover" />
              ...
              <div className="absolute bottom-6 left-6 right-6 grid grid-cols-3 gap-2">
                {[{ v: "100+", l: "Brands" }, { v: "12+", l: "Years" }, { v: "7", l: "Disciplines" }].map((s) => (
                  <div key={s.l} className="text-center py-4 rounded-xl" style={{ background: "rgba(10,10,12,0.88)", border: "1px solid rgba(255,255,255,0.1)" }}>
                    <div className="text-xl font-black" style={{ color: "#C2A46D" }}>{s.v}</div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-8 h-px" style={{ background: "#C2A46D" }} />
              <span className="text-[9px] font-black uppercase tracking-[0.38em]" style={{ color: "#C2A46D" }}>Our Values</span>
              <div className="w-8 h-px" style={{ background: "#C2A46D" }} />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {values.map((v) => (
              <div key={v.num} className="p-8 rounded-2xl" style={{ background: "#17171C", border: "1px solid rgba(255,255,255,0.07)" }}>
                <div className="text-[10px] font-black tracking-widest mb-4" style={{ color: "#C2A46D" }}>{v.num}</div>
      ...
      <section className="py-24" style={{ background: "#0A0A0C" }}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-black mb-6" style={{ color: "#EDEDED" }}>Work With LO ECHSAR</h2>
